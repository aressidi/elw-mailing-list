...
CREATE INDEX IF NOT EXISTS "mailings_campaign_property_idx" ON "mailings" USING btree ("campaign_id","property_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "mailings_campaign_owner_idx" ON "mailings" USING btree ("campaign_id","owner_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "owners_archived_at_idx" ON "owners" USING btree ("archived_at");